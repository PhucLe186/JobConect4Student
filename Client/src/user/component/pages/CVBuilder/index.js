...
function CVBuilder() {
        ...
        project.id === projectId
          ? {
              ...
              bullets: project.bullets.filter(
                (bullet, index) => index !== bulletIndex,
              ),
            }
          : project,
      ),
  ...
  const visibleContacts = CONTACT_FIELDS.filter((field) =>
    cvData.contacts[field.key].trim(),
  );
  ...
  const handleExportPDF = async () => {
    ...
    const pages = Array.from(
      previewRef.current.querySelectorAll(`.${styles.cvPage}`),
    );
    if (!pages.length) {
      return;
    }
    ...
    <div className={styles.builderPage}>
      <section className={styles.editorPanel}>
        <div className={styles.editorHeader}>
          <div>
            <p className={styles.kicker}>Tao CV</p>
            <h1>Mau CV co dinh theo file mau</h1>
            <p className={styles.editorHint}>
              Layout nay da duoc khoa theo dung mot form CV. Ban chi can nhap
              noi dung, anh dai dien va tai PDF.
            </p>
          </div>
          <div className={styles.editorActions}>
            ...
            <button
              ...
              disabled={exporting}
            >
              {exporting ? 'Dang xuat PDF...' : 'Tai PDF'}
            </button>
          </div>
        </div>
        ...
        <div className={styles.editorGrid}>
          <div className={styles.editorCard}>
            ...
            <div className={styles.formGroup}>
              ...
              <input
                ...
                onChange={(event) =>
                  updateRootField('fullName', event.target.value)
                }
              />
            </div>
            <div className={styles.formGroup}>
              <label htmlFor="headline">Vi tri</label>
              <input
                id="headline"
                value={cvData.headline}
                onChange={(event) =>
                  updateRootField('headline', event.target.value)
                }
              />
            </div>
            <div className={styles.formGroup}>
            ...
            <div className={styles.formGroup}>
              ...
              <textarea
                ...
                onChange={(event) =>
                  updateRootField('objective', event.target.value)
                }
              />
            </div>
            <div className={styles.formGroup}>
              ...
              <input
                ...
                onChange={(event) =>
                  updateRootField('repoLink', event.target.value)
                }
              />
            </div>
          </div>
          ...
          <div className={styles.editorCard}>
            <h2>Hoc van</h2>
            <div className={styles.formGroup}>
              <label htmlFor="major">Chuyen nganh</label>
              <input
                id="major"
            ...
            <div className={styles.formGroup}>
              <label htmlFor="eduPeriod">Thoi gian hoc</label>
              <input
                id="eduPeriod"
                value={cvData.education.period}
                onChange={(event) =>
                  updateNestedField('education', 'period', event.target.value)
                }
              />
            </div>
            <div className={styles.formGroup}>
              <label htmlFor="school">Truong</label>
              <input
                id="school"
            ...
            <div className={styles.formGroup}>
              <label htmlFor="research">Dong nghien cuu</label>
              <input
                id="research"
                value={cvData.education.research}
                onChange={(event) =>
                  updateNestedField('education', 'research', event.target.value)
                }
              />
            </div>
            <div className={styles.formGroup}>
              <label htmlFor="researchPeriod">Thoi gian nghien cuu</label>
              <input
                id="researchPeriod"
                value={cvData.education.researchPeriod}
                onChange={(event) =>
                  updateNestedField(
                    'education',
                    'researchPeriod',
            ...
            <aside className={styles.leftColumn}>
              ...
              <div className={styles.leftSection}>
                ...
                <div className={styles.leftBlock}>
                  ...
                  {cvData.education.research && (
                    <p>{cvData.education.research}</p>
                  )}
                  {cvData.education.researchPeriod && (
                    <p>{cvData.education.researchPeriod}</p>
                  )}
                </div>
              </div>
