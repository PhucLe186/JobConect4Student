const translations={
        vi: {     
            ...
            email: 'Email',
            ph_phone: 'Nhập số điện thoại liên hệ',
            website: 'Website',
            ...
            send: 'Gửi',
            editsuccess: 'Dữ liệu của bạn đã được lưu lại.',
            editBtn: 'Chỉnh sửa',
            companyIndustry:'Lĩnh vực công ty',
            ph_companyIndustry:'Chọn lĩnh vực công ty',
            province:'Tỉnh/Thành', 
            ph_province:'Chọn tỉnh/thành phố',
            district: 'Quận/Huyện',
            ph_district: 'Chọn quận/huyện',
            ph_address_detail:'Số nhà, đường, phường…'
            },
        en: {
<<<<<<< HEAD
...
=======
            ph_address_detail:'house number, street, ward…',
            ph_district: 'Select district',
            district:'District',
            ph_province:'Select province',
            province:'Province',
            ph_companyIndustry:'Select industry',
            companyIndustry:'Company industry',
            editsuccess: 'Your data has been successfully saved.',
            editBtn: 'Edit',
>>>>>>> 8047f60e (update api edit information employer)
            Logout:'Logout',
