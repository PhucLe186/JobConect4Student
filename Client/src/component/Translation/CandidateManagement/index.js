const trans__candidateManagement = {
  vi: {
    ...
    pageDescription:
      'Nhà tuyển dụng có thể tick tiêu chí để lọc CV. Nếu chưa chọn tiêu chí nào, hệ thống sẽ tự động hiển thị đầy đủ danh sách CV.',
    ...
    criteriaDescription: 'Tick một hoặc nhiều tiêu chí để hiển thị các CV phù hợp. Bỏ trống để xem toàn bộ danh sách CV.',
    ...
    outstandingModeTitle: 'Tất cả danh sách CV',
    outstandingModeText: 'Chưa có tiêu chí nào được chọn, danh sách đang hiển thị đầy đủ các CV.',
    ...
    noResultOutstanding: 'Chưa có CV nào trong hệ thống.',
  ...
  en: {
    ...
    pageDescription:
      'Recruiters can tick criteria to filter CVs. If no criteria are selected, the system automatically shows all CVs.',
    panelTitle: 'CV list',
    ...
    criteriaDescription: 'Tick one or more criteria to show matching CVs. Leave everything unchecked to see all CVs.',
    ...
    outstandingModeTitle: 'All CVs mode',
    outstandingModeText: 'No criteria are selected, so the list is showing all CVs.',
    ...
    noResultOutstanding: 'No CVs available.',
